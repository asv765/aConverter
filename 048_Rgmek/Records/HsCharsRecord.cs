...
{
    [TableName("HsChars.DBF")]
    public partial class HscharsRecord : AbstractRecord
    {
        ...
        {
            HscharsRecord retValue = new HscharsRecord();
