...
{
    [TableName("FlChars.DBF")]
    public partial class FlcharsRecord : AbstractRecord
    {
        ...
        // VALUE_N N(16,10)
        // </summary>
        [FieldName("VALUE_N"), FieldType('N'), FieldWidth(16), FieldDec(10)]
        public decimal Value_n
        {
            get { return value_n; }
            set { CheckDecimalData("Value_n", value, 16, 10); value_n = value; }
        }
        ...
        {
            FlcharsRecord retValue = new FlcharsRecord();
