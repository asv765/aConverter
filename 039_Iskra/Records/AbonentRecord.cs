...
namespace _039_Iskra
{
    ...
    public partial class AbonentRecord : AbstractRecord
    {
        ...
        private Int64 isindivid;
        // <summary>
        // ISINDIVID N(2)
        // </summary>
        [FieldName("ISINDIVID"), FieldType('N'), FieldWidth(2)]
        public Int64 Isindivid
        {
            get { return isindivid; }
            set { CheckIntegerData("Isindivid", value, 2); isindivid = value; }
        }
        ...
        public override void ReadDataRow(System.Data.DataRow ADataRow)
        {
            ...
            if (ADataRow.Table.Columns.Contains("ISINDIVID")) Isindivid = Convert.ToInt64(ADataRow["ISINDIVID"]); else Isindivid = 0;
        ...
        public override AbstractRecord Clone()
        {
            ...
            retValue.Isindivid = this.Isindivid;
