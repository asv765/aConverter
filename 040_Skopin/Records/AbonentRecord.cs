...
namespace _040_Skopin
{
    ...
    public partial class AbonentRecord : AbstractRecord
    {
        ...
        // KORPUS N(3)
        // </summary>
        [FieldName("KORPUS"), FieldType('N'), FieldWidth(3)]
        public Int64 Korpus
        {
            get { return korpus; }
            set { CheckIntegerData("Korpus", value, 3); korpus = value; }
        }
