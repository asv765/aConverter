...
{
    [TableName("PROMEG.DBF")]
    public partial class PromegRecord: AbstractRecord
    {
        ...
        {
            PromegRecord retValue = new PromegRecord();
