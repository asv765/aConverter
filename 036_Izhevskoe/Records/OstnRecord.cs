...
{
    [TableName("OSTN.DBF")]
    public partial class OstnRecord: AbstractRecord
    {
        ...
        {
            OstnRecord retValue = new OstnRecord();
