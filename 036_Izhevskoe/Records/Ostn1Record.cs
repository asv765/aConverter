...
{
    [TableName("OSTN1.DBF")]
    public partial class Ostn1Record: AbstractRecord
    {
        ...
        // S_KVART N(9,2)
        // </summary>
        [FieldName("S_KVART"), FieldType('N'), FieldWidth(9), FieldDec(2)]
        public decimal S_kvart
        {
            get { return s_kvart; }
            set { CheckDecimalData("S_kvart", value, 9, 2); s_kvart = value; }
        }
        ...
        // S_NAIM N(9,2)
        // </summary>
        [FieldName("S_NAIM"), FieldType('N'), FieldWidth(9), FieldDec(2)]
        public decimal S_naim
        {
            get { return s_naim; }
            set { CheckDecimalData("S_naim", value, 9, 2); s_naim = value; }
        }
        ...
        // S_WATER N(9,2)
        // </summary>
        [FieldName("S_WATER"), FieldType('N'), FieldWidth(9), FieldDec(2)]
        public decimal S_water
        {
            get { return s_water; }
            set { CheckDecimalData("S_water", value, 9, 2); s_water = value; }
        }
        ...
        // S_KANAL N(9,2)
        // </summary>
        [FieldName("S_KANAL"), FieldType('N'), FieldWidth(9), FieldDec(2)]
        public decimal S_kanal
        {
            get { return s_kanal; }
            set { CheckDecimalData("S_kanal", value, 9, 2); s_kanal = value; }
        }
        ...
        {
            Ostn1Record retValue = new Ostn1Record();
