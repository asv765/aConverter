...
{
    [TableName("FPLA_N.DBF")]
    public partial class Fpla_nRecord: AbstractRecord
    {
        ...
        {
            Fpla_nRecord retValue = new Fpla_nRecord();
