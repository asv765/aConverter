...
{
    [TableName("USLUGA4.DBF")]
    public partial class Usluga4Record: AbstractRecord
    {
        ...
        {
            Usluga4Record retValue = new Usluga4Record();
