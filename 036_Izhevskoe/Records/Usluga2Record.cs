...
{
    [TableName("USLUGA2.DBF")]
    public partial class Usluga2Record: AbstractRecord
    {
        ...
        {
            Usluga2Record retValue = new Usluga2Record();
