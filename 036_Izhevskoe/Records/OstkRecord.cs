...
{
    [TableName("OSTK.DBF")]
    public partial class OstkRecord: AbstractRecord
    {
        ...
        {
            OstkRecord retValue = new OstkRecord();
