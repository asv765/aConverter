...
{
    [TableName("USLUGA3.DBF")]
    public partial class Usluga3Record: AbstractRecord
    {
        ...
        {
            Usluga3Record retValue = new Usluga3Record();
