...
{
    [TableName("ARX_OST.DBF")]
    public partial class Arx_ostRecord: AbstractRecord
    {
        ...
        {
            Arx_ostRecord retValue = new Arx_ostRecord();
