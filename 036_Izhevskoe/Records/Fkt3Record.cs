...
{
    [TableName("FKT3.DBF")]
    public partial class Fkt3Record: AbstractRecord
    {
        ...
        {
            Fkt3Record retValue = new Fkt3Record();
