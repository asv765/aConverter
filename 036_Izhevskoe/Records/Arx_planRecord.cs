...
{
    [TableName("ARX_PLAN.DBF")]
    public partial class Arx_planRecord: AbstractRecord
    {
        ...
        {
            Arx_planRecord retValue = new Arx_planRecord();
