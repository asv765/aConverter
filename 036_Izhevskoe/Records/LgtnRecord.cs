...
{
    [TableName("LGTN.DBF")]
    public partial class LgtnRecord: AbstractRecord
    {
        private Int64 nom;
        // <summary>
        // NOM N(3)
        ...
        {
            LgtnRecord retValue = new LgtnRecord();
        ...
        {
            string rs = String.Format("INSERT INTO LGTN (NOM, IND_L, KATEG, KVART, OTOPL, LIGHT, WATER) VALUES ({0}, '{1}', '{2}', {3}, {4}, {5}, {6})", Nom.ToString(), String.IsNullOrEmpty(Ind_l) ? "" : Ind_l.Trim(), String.IsNullOrEmpty(Kateg) ? "" : Kateg.Trim(), Kvart.ToString(), Otopl.ToString(), Light.ToString(), Water.ToString());
            return rs;
        }
    }
}
