...
namespace aConverterClassLibrary.Records
{
    ...
    public class CntrsindRecord: AbstractRecord
    {
        ...
        // OLDIND N(13,4)
        // </summary>
        [FieldName("OLDIND"), FieldType('N'), FieldWidth(13), FieldDec(4)]
        public decimal Oldind
        {
            get { return oldind; }
            set { CheckDecimalData("Oldind", value, 13, 4); oldind = value; }
        }
        ...
        // OB_EM N(13,4)
        // </summary>
        [FieldName("OB_EM"), FieldType('N'), FieldWidth(13), FieldDec(4)]
        public decimal Ob_em
        {
            get { return ob_em; }
            set { CheckDecimalData("Ob_em", value, 13, 4); ob_em = value; }
        }
        ...
        // INDICATION N(13,4)
        // </summary>
        [FieldName("INDICATION"), FieldType('N'), FieldWidth(13), FieldDec(4)]
        public decimal Indication
        {
            get { return indication; }
            set { CheckDecimalData("Indication", value, 13, 4); indication = value; }
        }
