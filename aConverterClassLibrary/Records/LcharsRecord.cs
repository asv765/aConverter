...
namespace aConverterClassLibrary.Records
{
    ...
    public class LcharsRecord: AbstractRecord
    {
        ...
        // LCHARNAME C(70)
        // </summary>
        [FieldName("LCHARNAME"), FieldType('C'), FieldWidth(100), FieldDescription("Наименование характеристики")]
        ...
        // VALUEDESC C(70)
        // </summary>
        [FieldName("VALUEDESC"), FieldType('C'), FieldWidth(100), FieldDescription("Расшифровка значения")]
