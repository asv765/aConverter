...
namespace aConverterClassLibrary.Records
{
    ...
    public class NachRecord: AbstractRecord
    {
        ...
        // FNATH N(13,2)
        // </summary>
        [FieldName("FNATH"), FieldType('N'), FieldWidth(13), FieldDec(2), FieldDescription("Сумма начисления")]
        ...
        // PROCHL N(13,2)
        // </summary>
        [FieldName("PROCHL"), FieldType('N'), FieldWidth(13), FieldDec(2), FieldDescription("Сумма перерасчета")]
        ...
        //// LGPROCH N(13,2)
        //// </summary>
        //[FieldName("LGPROCH"), FieldType('N'), FieldWidth(13), FieldDec(2), FieldDescription("Сумма перерасчета по льготам")]
