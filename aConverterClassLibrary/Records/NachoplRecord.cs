...
namespace aConverterClassLibrary.Records
{
    ...
    public partial class NachoplRecord: AbstractRecord
    {
        ...
        public Int64 Month
        {
            ...
            set 
            {
                if (value < 1 || value > 12) throw new Exception("Неверное значение Month");
                CheckIntegerData("Month", value, 2); 
                month = value; 
            }
        }
        ...
        // BDEBET N(13,2)
        // </summary>
        [FieldName("BDEBET"), FieldType('N'), FieldWidth(18), FieldDec(4), FieldDescription("Долг (+) или переплата (-) на начало месяца")]
        ...
        // FNATH N(13,2)
        // </summary>
        [FieldName("FNATH"), FieldType('N'), FieldWidth(18), FieldDec(4), FieldDescription("Начисление в текущем месяце")]
        ...
        // OPLATA N(13,2)
        // </summary>
        [FieldName("OPLATA"), FieldType('N'), FieldWidth(18), FieldDec(2), FieldDescription("Сумма оплаты")]
        public decimal Oplata
        {
            get { return oplata; }
            set { CheckDecimalData("Oplata", value, 18, 2); oplata = value; }
        }
        ...
        // EDEBET N(13,2)
        // </summary>
        [FieldName("EDEBET"), FieldType('N'), FieldWidth(18), FieldDec(4), FieldDescription("Долг (+) или переплата (-) на конец месяца")]
