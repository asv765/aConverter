...
declare variable recountkoefficient numeric(18,5);
begin
  ...
  for select C.LSHET, C.COUNTERID, C.CNTTYPE, C.SERIALNUM, C.SETUPDATE, C.DEACTDATE, C.SETUPPLACE, C.PLOMBDATE,
             ...
             C.TARGETBALANCE_KOD, C.DISTRIBUTINGMETHOD, C.TARGETNEGATIVEBALANCE_KOD, C.GROUPCOUNTERMODULEID, C.KODREGIM, C.NOCALCCHILDBALANCES, C.UNTINGID, C.RECOUNTKOEFFICIENT
      from CNV$COUNTERS C
      ...
      into :LSHET, :COUNTERID, :CNTTYPE, :SERIALNUM, :SETUPDATE, :DEACTDATE, :SETUPPLACE, :PLOMBDATE, :PLOMBNAME,
           ...
           :DISTRIBUTINGMETHOD, :TARGETNEGATIVEBALANCE_KOD, :GROUPCOUNTERMODULEID, :KODREGIM, :NOCALCCHILDBALANCES, :UNTINGID, :recountkoefficient
  do
  begin
    ...
    insert into RESOURCECOUNTERS (KOD, KODCOUNTERSTYPES, SETUPDATE, COUNTER_LEVEL, COUNTERPLACE, DATEPPR, LASTPPRDATE,
                                  NAME, TARGETBALANCE_KOD, DISTRIBUTINGMETHOD, TARGETNEGATIVEBALANCE_KOD, NOCALCCHILDBALANCES, RECOUNTKOEFFICIENT)
    values (:EQUIPMENTID, :CNTTYPE, :SETUPDATE, :COUNTER_LEVEL, :SETUPPLACE, :NEXTPOV, :LASTPOV, :NAME,
            :TARGETBALANCE_KOD, :DISTRIBUTINGMETHOD, :TARGETNEGATIVEBALANCE_KOD, :NOCALCCHILDBALANCES, :recountkoefficient);
