...
begin
  ...
  for select C.LSHET, C.COUNTERID, C.CNTTYPE, C.SERIALNUM, C.SETUPDATE, C.DEACTDATE, C.SETUPPLACE, C.PLOMBDATE,
             ...
             C.TARGETBALANCE_KOD, C.DISTRIBUTINGMETHOD, C.TARGETNEGATIVEBALANCE_KOD, C.GROUPCOUNTERMODULEID, C.KODREGIM, C.NOCALCCHILDBALANCES
      from CNV$COUNTERS C
      ...
      into :LSHET, :COUNTERID, :CNTTYPE, :SERIALNUM, :SETUPDATE, :DEACTDATE, :SETUPPLACE, :PLOMBDATE, :PLOMBNAME,
           ...
           :DISTRIBUTINGMETHOD, :TARGETNEGATIVEBALANCE_KOD, :GROUPCOUNTERMODULEID, :KODREGIM, :NOCALCCHILDBALANCES
  do
  begin
