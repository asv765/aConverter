...
namespace aConverterClassLibrary
{
    public class OplataYearMonthCheckCase: CheckCase
    {
        ...
        {
            this.CheckCaseName = String.Format("Проверяется, что в файле OPLATA.DBF значение в поле MONTH находится в диапазоне от 1 до 12, а значение в поле YEAR находится в диапазоне от 2000 до {0}",
                DateTime.Now.Year);
