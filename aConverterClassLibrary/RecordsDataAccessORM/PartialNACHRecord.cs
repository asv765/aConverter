        ...
        public string InsertSQL
        {
            get
            {
                ...
                var insertNachTemplate =
                    "INSERT INTO CNV$NACH (ID, LSHET, DOCUMENTCD, MONTH_, YEAR_, MONTH2, YEAR2, FNATH, PROCHL, PROCHLVOLUME, VOLUME, REGIMCD, REGIMNAME, SERVICECD, SERVICENAME, DATE_VV, TYPE_, DOCNAME, DOCNUMBER, DOCDATE) " +
