...
namespace _043_PkStroy
{
    ...
    public partial class AbonentRecord : AbstractRecord
    {
        ...
        // HOUSECD C(9)
        // </summary>
        [FieldName("HOUSECD"), FieldType('C'), FieldWidth(9)]
        public string Housecd
        {
            get { return housecd; }
            set { CheckStringData("Housecd", value, 9); housecd = value; }
        }
        ...
        // ADDRESS C(100)
        // </summary>
        [FieldName("ADDRESS"), FieldType('C'), FieldWidth(100)]
        public string Address
        {
            get { return address; }
            set { CheckStringData("Address", value, 100); address = value; }
        }
